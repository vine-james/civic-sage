Feature: Remembering previous prompt
  ...
  Scenario: Remember and recall previous words
    ...
    When I ask the prompt "What does Paul Holmes think about Donald Trump?" using rag_llm_utils with history
    And I ask the prompt "What did we just talk about?" using rag_llm_utils with history
    Then the answer should contain the text "Donald Trump"